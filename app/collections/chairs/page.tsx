            ...
            <section className="bg-secondary text-secondary-foreground py-16 md:py-24 border-b border-border/40">
                <div className="container mx-auto px-4 text-center max-w-4xl">
                    ...
                    <p className="mt-4 text-base md:text-lg text-secondary-foreground/80">
                        Sculptural seating that merges comfort with artistry. Each chair becomes
                        a statement piece—where heritage wood grains dance with luminous epoxy,
                        creating iconic moments of elegance in every space.
                    </p>
                    <div className="mt-6 flex justify-center gap-4">
                        ...
                        <Link
                            href="/contact?subject=Chairs%20Enquiry"
            ...
            <section className="py-10 md:py-14 px-section-px bg-primary/5 border-b border-border/40">
                <div className="container mx-auto max-w-4xl text-center md:text-left">
                    ...
                    <p className="mt-3 text-sm md:text-base text-foreground/80">
                        Commanding in presence yet inviting in comfort, our chairs are sculptural
                        masterpieces that elevate every setting—blending organic wood elegance with
                        crystalline resin artistry for unforgettable seating experiences.
                    </p>
                </div>
            </section>
            ...
            <section className="py-12 px-section-px bg-background border-y border-border/40">
                <div className="container mx-auto flex flex-col md:flex-row items-start md:items-center gap-8">
                    <div className="flex-1">
                        ...
                        <p className="mt-3 text-sm md:text-base text-foreground/80">
                            Customize height, backrest design, wood species, and resin accents to harmonize
                            with your interior vision. Perfect for dining sets, offices, galleries, and
                            homes seeking distinctive artistic seating.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-section-py px-section-px bg-primary/3">
                <div className="container mx-auto text-center max-w-2xl">
                    ...
                    <p className="mt-4 text-sm md:text-base text-foreground/80">
                        Bring your vision to life. Share inspiration, dimensions, or design preferences—our
                        artisans will craft bespoke timber and resin seating that transforms your
                        space into a showcase of sophistication.
                    </p>
                    <div className="mt-8 flex justify-center gap-4">
                        <Link
                            href="/contact?subject=Custom%20Chair%20Design"
